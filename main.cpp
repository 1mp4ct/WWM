...
int main(){
    ...
    question.append(qa8);
    question.append(qa9);
    question.append(qa10);
    question.append(qa11);
    question.append(qa12);
    question.append(qa13);
    question.append(qa14);
        ...
        for(int i = 0; i < question.size(); i++){
            question.at(i);
            cout << question.at(i).qw << endl;
            cout << question.at(i).an1 << endl;
            cout << question.at(i).an2 << endl;
            cout << question.at(i).an3 << endl;
            cout << question.at(i).an4 << endl;
            cin >> eingabe;
            if(eingabe == question.at(i).ar){
